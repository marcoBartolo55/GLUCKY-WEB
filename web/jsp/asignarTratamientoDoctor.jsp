<%-- 
    Document   : asignarTratamientoDoctor
    Created on : 17 nov 2022, 00:19:15
    Author     : Gonzalo
--%>
...
<html lang="en" dir="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" href="../css/asignarTratamientoDoctor.css">
    ...
    <div class="container">
        ...
        <div class="content">
          ...
          <div class=textoarriba>
            Has seleccionado al paciente, ahora deberás asignar su tratamiento.
          </div>
            <br>
            <div class="moverle">
              ...
              <div class="tratamiento">
                <table class="tabla">
                  ...
                  <tr>
                    <td colspan="2" class="c"><i>Deberás escribir el tratamiento de tu paciente; ¡usa el formato que quieras!</i></td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <button class="boton">
