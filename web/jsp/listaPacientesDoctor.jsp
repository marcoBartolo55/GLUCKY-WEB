<%-- 
    Document   : listaPacientesDoctor
    Created on : 17 nov 2022, 00:30:45
    Author     : Gonzalo
--%>
...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="../css/listaPacientesDoctor.css">
    <!-- Boxicons CDN Link -->
  ...
  <div class="container">
    ...
    <!-- Aquí abre el div de contenido de un doctor -->
            ...
            <div class=cuadradoblancodos> 
                ...
                <input type="submit" value="Ver" class="sino"> 
              </form> 
    
              <div>ㅤ</div>
    
                <form action="#" class="formu"></form> 
                <input type="submit" value="Chatear" class="sino"> 
              </form> 
            </div>  
