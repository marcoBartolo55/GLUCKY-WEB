<%-- 
    ...
    Created on : 16 nov 2022, 21:39:25
    Author     : Gonzalo
--%>
...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="../css/agendaDoctorEspecifica.css">
    <!-- Boxicons CDN Link -->
...
<body>
         ...
         <div class="profile-details">
           ...
           <div class="name_job">
               <div class="name">
                   ...
                   <%System.out.println("cedula doctor");%>
               </div>
  ...
  <div class="container">
      <div class="title">Buenos dias 
       ...
       <%System.out.println("nombre doctor");%></div>
      <div class="content">
    ...
    <!-- Aquí abre el div de contenido de un doctor -->
         ...
         <div class=cuadradoblancodos> 
          <form action="#" class="formu3">
            <input type="text" id="CURP" name="CURP" value="#" class="forminvitexDOS"   ><br>
        ...
        <input type="submit" value="✓" class="formi">
        </form>
